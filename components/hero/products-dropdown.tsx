  ...
  return (
    <main className="py-2 pt-4">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-[200px_230px_200px] gap-x-4 w-auto">
          ...
          <div className="text-neutral-500">
            ...
            <div className=" flex flex-col gap-y-4">
              <div className=" group">
                ...
                >
                  <div className=" rounded-sm p-2 border flex items-center group-hover:bg-white justify-center border-neutral-900">
                    <TbBrandNextjs className="inline-block  text-white group-hover:text-black " />
                  </div>
                  <div>
                    <p className=" text-white">Next.js</p>
                    <p className=" text-[0.6rem]">The native nextjs platform</p>
                  </div>
                </Link>
              </div>
              <div className=" group">
